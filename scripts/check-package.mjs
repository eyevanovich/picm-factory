...
const previewReviewGuidance = {
  ...
  "skills/picm-factory/references/adoption-guide.md": ["preview-review-protocol.md", "direct explicit approval"],
  "skills/picm-factory/references/coding-adoption-guide.md": ["preview-review-protocol.md", "direct approval"],
  ...
  "extensions/picm-factory.ts": [
    "summary-preview and exact-review protocol",
    "adoption/maintenance/optimization summary-preview, on-demand exact-review, and direct summary-approval behavior",
  ],
