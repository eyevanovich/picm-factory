...
2. Ask whether the workspace contains secrets, regulated data, client data, private material, or exact paths that must not be inspected. No other agent tool is available until this privacy review completes.
