...
11. Use the selected layout's review gate:
    ...
    - Coding Repository: route one real change from root instructions through the map/equivalent to the owning boundary, entry point, and authoritative tests/checks; review the diff and check result while keeping cross-boundary effects and unknowns visible.
