...
- Applies the required agent-document writing lens after the ledger: context pointers name their target and reading condition without hiding stable prerequisites; hierarchy progressively discloses only conditional material; canonical homes and thin pointers preserve reachable local routes; completion criteria clarify existing intent without inventing requirements, verification, or human gates; pruning retains deliberately repeated safety, review, and local-boundary guidance.
